...
namespace BlackBytesBox.DepreactedNet2.Base
{
    ...
    namespace ConsoleApplication1
    {
        ...
        public class CmdHostControl : UserControl
        {
            ...
            private void InitializeComponent()
            {
                ...
                outputTextBox.Font = new System.Drawing.Font("Courier New", 9f);
                ...
                inputTextBox.Font = new System.Drawing.Font("Courier New", 9f);
                inputTextBox.BackColor = System.Drawing.Color.Black;
                inputTextBox.ForeColor = System.Drawing.Color.LightGreen;
        ...
        /// <summary>
        /// Example WinForms application that hosts the CmdHostControl.
        /// </summary>
        public class MainForm : Form
        {
            private CmdHostControl cmdHost;
            ...
            public MainForm()
            {
                Text = "CMD Host Example";
                Width = 800;
                Height = 600;
                StartPosition = FormStartPosition.CenterScreen;

                cmdHost = new CmdHostControl();
                cmdHost.Dock = DockStyle.Fill;
                Controls.Add(cmdHost);
            }
